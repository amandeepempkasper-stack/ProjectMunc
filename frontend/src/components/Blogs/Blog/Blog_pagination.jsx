...
const Blog_pagination = () => {
  ...
  return (
    <div style={{ backgroundColor: "#f5f3ff", minHeight: "100vh" }}>
      <Navbar />
      <Container className="text-center py-4">
        ...
        <h3 className="fw-bold">Read Our Latest Blogs</h3>
        ...
        <Row className="gy-4">
          {currentBlogs.map((post) => (
            <Col key={post._id} xs={12} sm={6} md={4} lg={3}>
                    ...
                    <img
                      src={
                        Array.isArray(post.thumbnail) && post.thumbnail.length > 0
                          ? `${post.thumbnail[0].startsWith("/") ? post.thumbnail[0].slice(1) : post.thumbnail[0]}`
                          : post.image
                          ? post.image
                ...
                <div className="blog-part-inner flex-grow-1 d-flex flex-column" style={{ padding: '10px'}}>
