  ...
  return (
    ...
    "
                ...
                <input
                  ...
                  placeholder="Enter your phone"
                  required
                  className="h-12 w-full rounded-lg border border-black/10 px-2 outline-none focus:ring-2 focus:ring-[#727272] placeholder:text-sm"
                />
                ...
                <div className="relative w-full">
                  <select
                    ...
                    onChange={handleChange}
                    required
                    className="h-12 w-full rounded-lg border border-black/10 px-1.5 pr-6 outline-none focus:ring-2 focus:ring-[#727272] text-[#727272] appearance-none text-sm"
                  >
                    <option value="" disabled hidden>
                      Our Products
                    </option>
