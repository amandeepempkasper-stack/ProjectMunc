  ...
  return (
    <>
      <div className="bg-[#F0FDFF] px-4 sm:px-6 md:px-12 lg:px-20 xl:px-28 2xl:px-40">
        <div className="max-w-7xl 2xl:max-w-[1600px] mx-auto py-0 sm:py-12 lg:py-16 ">
            ...
            {features.map((item, idx) => (
              ...
              >
                ...
                <div className="mt-4 sm:mt-0 sm:px-4 lg:px-6 text-center sm:text-left">
                  <h3 className="text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl 2xl:text-5xl font-medium leading-snug">
